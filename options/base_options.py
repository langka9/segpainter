...
class BaseOptions():
    ...
    def initialize(self, parser):
        # base define
        parser.add_argument('--model', type=str, default='vssmsegblkscan', help='name of the model type. [vssmsegblkscan]')
        parser.add_argument('--modal', default='segmentation', type=str, help='[segmentation]')
        ...
        parser.add_argument('--datamax', type=int, default=20000, help='the max number of loaded data.')
        ...
        parser.add_argument('--no_use_mask', action='store_true',help='if true, do not use mask.')
        parser.add_argument('--noise_mode', type=str, default='random', help='random | const')
        parser.add_argument('--no_use_noise', action='store_true', help='if true, Decoder uses noise.')
        parser.add_argument('--task', type=str, default='inpainting', help='inpainting | synthesis')
        parser.add_argument('--loadSize', type=int, default=266, help='scale images to this size')
        parser.add_argument('--fineSize', type=int, default=256, help='then crop to this size')
        parser.add_argument('--label_nc', default=0, type=int, help='Number of input label channels to the psp encoder')
    ...
    def print_options(opt):
        ...
        # save to the disk
        expr_dir = os.path.join(opt.run_dir)
